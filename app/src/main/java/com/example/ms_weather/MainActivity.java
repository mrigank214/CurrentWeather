package com.example.ms_weather;
...
import com.example.ms_weather.Common.Common;
import com.example.ms_weather.Helper.Helper;
import com.example.ms_weather.Model.OpenWeatherMap;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private class GetWeather extends AsyncTask<String,Void,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            txtDescription.setText(String.format("CLIMATE: %s",openWeatherMap.getWeather().get(0).getDescription()));
            ...
            txtCelsius.setText(String.format("TEMP: %.2f °C",openWeatherMap.getMain().getTemp()));
            Picasso.get()
